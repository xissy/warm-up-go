...
//
//		type Foo struct{}
// 		func (f *Foo) Bar(ctx, req, res) error {
//			return nil
//		}
//
...
// Handle registres a handler interface with the default server to
...
// which wubscribes to specified topic with the broker
...
// signal before exiting. Also registres/deregisters the server
func Run() error {
	...
	signal.Notify(ch, syscall.SIGTERM, syscall.SIGNIT, syscall.SIGKILL)
